...
/* opening screen, dit had 100% makkelijker gekund maar moeilijk doen is mijn tweede naam */

function hideDressupGame() {
    dressupGame.classList.add("hide")
}
hideDressupGame()

setTimeout(function opening1(){opening.src = "images/ihavenolife/2.png"}, 5000)

setTimeout(function opening2(){opening.src = "images/ihavenolife/3.png"}, 5250)

setTimeout(function opening3(){opening.src = "images/ihavenolife/4.png"}, 5500)

setTimeout(function opening4(){opening.src = "images/ihavenolife/5.png"}, 5750)

setTimeout(function opening5(){opening.src = "images/ihavenolife/6.png"}, 6000)

setTimeout(function opening6(){opening.src = "images/ihavenolife/7.png"}, 6250)

setTimeout(function opening7(){opening.src = "images/ihavenolife/8.png"}, 6500)

setTimeout(function opening8(){opening.src = "images/ihavenolife/9.png"}, 6750)

setTimeout(function opening9(){opening.src = "images/ihavenolife/10.png"}, 7000)

setTimeout(function opening10(){opening.src = "images/ihavenolife/11.png"}, 7250)

setTimeout(function opening11(){opening.src = "images/ihavenolife/12.png"}, 7500)

setTimeout(function opening12(){opening.src = "images/ihavenolife/13.png"}, 7750)

setTimeout(function opening13(){opening.src = "images/ihavenolife/14.png"}, 8000)

setTimeout(function opening14(){opening.src = "images/ihavenolife/15.png"}, 8250)

setTimeout(function opening15(){opening.src = "images/ihavenolife/16.png"}, 8500)

setTimeout(function opening16(){opening.src = "images/ihavenolife/17.png"}, 8750)

setTimeout(function opening17(){opening.src = "images/ihavenolife/18.png"}, 9000)

setTimeout(function opening18(){opening.src = "images/ihavenolife/19.png"}, 9250)

setTimeout(function opening19(){opening.src = "images/ihavenolife/20.png"}, 9500)

setTimeout(function opening20(){opening.src = "images/ihavenolife/21.png"}, 9750)

setTimeout(function opening21(){opening.src = "images/ihavenolife/22.png"}, 10000)

setTimeout(function opening22(){opening.src = "images/ihavenolife/23.png"}, 10250)

setTimeout(function opening23(){opening.src = "images/ihavenolife/24.png"}, 10500)

setTimeout(function opening24(){opening.src = "images/ihavenolife/25.png"}, 10750)

setTimeout(function opening25(){opening.src = "images/ihavenolife/26.png"}, 11000)

setTimeout(function opening26(){opening.src = "images/ihavenolife/27.png"}, 11250)

setTimeout(function opening27(){opening.src = "images/ihavenolife/28.png"}, 11500)

setTimeout(function opening28(){opening.classList.add("fade")}, 11750)

setTimeout(function opening29(){dressupGame.classList.remove("hide")}, 15750)
