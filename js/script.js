...
var opening = document.getElementById('epic');
...
var skintoneElements = [
  'images/body/skintone1.png',
  'images/body/skintone2.png',
  'images/body/skintone3.png',
  'images/body/skintone4.png',
  'images/body/skintone5.png',
];
var hairElements = [
  'images/hair/hair1.png',
  'images/hair/hair2.png',
  'images/hair/hair3.png',
  'images/hair/hair4.png',
  'images/hair/hair5.png',
];
var topElements = [
  'images/top/top1.png',
  'images/top/top2.png',
...
var shoesElements = [
  ...
  'images/shoes/shoes2.png',
  'images/shoes/shoes3.png',
  'images/shoes/shoes4.png',
];
...
backgroundButton1Element.addEventListener(
  'click',
  function () {
...
backgroundButton2Element.addEventListener(
  'click',
  function () {
...
backgroundButton3Element.addEventListener(
  'click',
  function () {
...
backgroundButton4Element.addEventListener(
  'click',
  function () {
...
backgroundButton5Element.addEventListener(
  'click',
  function () {
...
backgroundButton6Element.addEventListener(
  'click',
  function () {
...
skintone1ButtonElement.addEventListener(
  'click',
  function () {
...
skintone2ButtonElement.addEventListener(
  'click',
  function () {
...
skintone3ButtonElement.addEventListener(
  'click',
  function () {
...
skintone4ButtonElement.addEventListener(
  'click',
  function () {
...
skintone5ButtonElement.addEventListener(
  'click',
  function () {
...
hairButton1Element.addEventListener(
  'click',
  function () {
    changeHair('hair1');
  },
...
hairButton2Element.addEventListener(
  'click',
  function () {
    changeHair('hair2');
  },
...
hairButton3Element.addEventListener(
  'click',
  function () {
    changeHair('hair3');
  },
...
hairButton4Element.addEventListener(
  'click',
  function () {
    changeHair('hair4');
  },
...
hairButton5Element.addEventListener(
  'click',
  function () {
    changeHair('hair5');
  },
...
topButton1Element.addEventListener(
  'click',
  function () {
    changeTop('top1');
  },
...
topButton2Element.addEventListener(
  'click',
  function () {
    changeTop('top2');
  },
...
topButton3Element.addEventListener(
  'click',
  function () {
    changeTop('top3');
  },
...
topButton4Element.addEventListener(
  'click',
  function () {
    changeTop('top4');
  },
...
bottomButton1Element.addEventListener(
  'click',
  function () {
...
bottomButton2Element.addEventListener(
  'click',
  function () {
...
bottomButton3Element.addEventListener(
  'click',
  function () {
...
bottomButton4Element.addEventListener(
  'click',
  function () {
...
shoesButton1Element.addEventListener(
  'click',
  function () {
    changeShoes('shoes1');
  },
...
shoesButton2Element.addEventListener(
  'click',
  function () {
    changeShoes('shoes2');
  },
...
shoesButton3Element.addEventListener(
  'click',
  function () {
    changeShoes('shoes3');
  },
...
shoesButton4Element.addEventListener(
  'click',
  function () {
    changeShoes('shoes4');
  },
...
accessoryButton1Element.addEventListener(
  'click',
  function () {
...
accessoryButton2Element.addEventListener(
  'click',
  function () {
...
accessoryButton3Element.addEventListener(
  'click',
  function () {
...
accessoryButton4Element.addEventListener(
  'click',
  function () {
...
accessoryButton5Element.addEventListener(
  'click',
  function () {
...
function killBill() {
  if (
    accessoryElement.getAttribute('src') == 'images/accessory/accessory1.png' &&
    ...
    document.querySelector('.dosomething').src =
      'images/buttons/dosomethingbuttonkillbill.png';

    document.querySelector('.menubutton1').src =
      'images/buttons/menubuttonkillbill1.png';
    document.querySelector('.menubutton2').src =
      'images/buttons/menubuttonkillbill2.png';
    document.querySelector('.menubutton3').src =
      'images/buttons/menubuttonkillbill3.png';
    document.querySelector('.menubutton4').src =
      'images/buttons/menubuttonkillbill4.png';
    document.querySelector('.menubutton5').src =
      'images/buttons/menubuttonkillbill5.png';
    document.querySelector('.menubutton6').src =
      'images/buttons/menubuttonkillbill6.png';
    document.querySelector('.menubutton7').src =
      'images/buttons/menubuttonkillbill7.png';

    document.querySelector('.menubuttonselected1').src =
      'images/buttons/menubuttonselectedkillbill1.png';
    document.querySelector('.menubuttonselected2').src =
      'images/buttons/menubuttonselectedkillbill2.png';
    document.querySelector('.menubuttonselected3').src =
      'images/buttons/menubuttonselectedkillbill3.png';
    document.querySelector('.menubuttonselected4').src =
      'images/buttons/menubuttonselectedkillbill4.png';
    document.querySelector('.menubuttonselected5').src =
      'images/buttons/menubuttonselectedkillbill5.png';
    document.querySelector('.menubuttonselected6').src =
      'images/buttons/menubuttonselectedkillbill6.png';
    document.querySelector('.menubuttonselected7').src =
      'images/buttons/menubuttonselectedkillbill7.png';
    ...
    document.querySelector('.dosomething').src =
      'images/buttons/dosomethingbutton.png';

    document.querySelector('.menubutton1').src =
      'images/buttons/menubutton1.png';
    document.querySelector('.menubutton2').src =
      'images/buttons/menubutton2.png';
    document.querySelector('.menubutton3').src =
      'images/buttons/menubutton3.png';
    document.querySelector('.menubutton4').src =
      'images/buttons/menubutton4.png';
    document.querySelector('.menubutton5').src =
      'images/buttons/menubutton5.png';
    document.querySelector('.menubutton6').src =
      'images/buttons/menubutton6.png';
    document.querySelector('.menubutton7').src =
      'images/buttons/menubutton7.png';

    document.querySelector('.menubuttonselected1').src =
      'images/buttons/menubuttonselected1.png';
    document.querySelector('.menubuttonselected2').src =
      'images/buttons/menubuttonselected2.png';
    document.querySelector('.menubuttonselected3').src =
      'images/buttons/menubuttonselected3.png';
    document.querySelector('.menubuttonselected4').src =
      'images/buttons/menubuttonselected4.png';
    document.querySelector('.menubuttonselected5').src =
      'images/buttons/menubuttonselected5.png';
    document.querySelector('.menubuttonselected6').src =
      'images/buttons/menubuttonselected6.png';
    document.querySelector('.menubuttonselected7').src =
      'images/buttons/menubuttonselected7.png';
...
function randomBackground() {
  ...
  document.getElementById('background').src = backgroundElements[randomNummer];
}

function randomSkintone() {
  var randomNummer = Math.random() * 5;
  randomNummer = Math.floor(randomNummer);
  document.getElementById('skintone').src = skintoneElements[randomNummer];
}

function randomHair() {
  var randomNummer = Math.random() * 5;
  randomNummer = Math.floor(randomNummer);
  document.getElementById('hair').src = hairElements[randomNummer];
}

function randomTop() {
  var randomNummer = Math.random() * 4;
  randomNummer = Math.floor(randomNummer);
  document.getElementById('top').src = topElements[randomNummer];
}

function randomBottom() {
  var randomNummer = Math.random() * 4;
  randomNummer = Math.floor(randomNummer);
  document.getElementById('bottom').src = bottomElements[randomNummer];
}

function randomShoes() {
  var randomNummer = Math.random() * 4;
  randomNummer = Math.floor(randomNummer);
  document.getElementById('shoes').src = shoesElements[randomNummer];
}

function randomAccessory() {
  var randomNummer = Math.random() * 5;
  randomNummer = Math.floor(randomNummer);
  document.getElementById('accessory').src = accessoryElements[randomNummer];
}
